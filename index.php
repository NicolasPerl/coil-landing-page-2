        	...
        	<div class="max_width_container">
	        	...
	        	<div class="nav_btns_container">
	                    <nav class="cl-effect-1">
	                        <a href="/collegePickerLogin.php">Login</a> 
	                        <a href="/collegePickerSignup.php">Sign up</a> 
	                    </nav>
	        	</div>
...
<!-- request demo starts here -->
		...
		<div class="max_width_container">
			<div class="demo_input_container">
				...
				<a href="/collegePickerSignup.php" id="productButton2" class="btn btn-default btn-lg"><strong>GET STARTED</strong></a>
